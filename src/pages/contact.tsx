      ...
      <main className={styles.contactContainer}>
        <section className={`${styles.heroSection} ${styles.animate}`}>
          ...
          <AnimatedTextReveal as="p" scrollTrigger={false} className={styles.subtitle}>
            Have a question or just want to chat? We'd love to hear from you. Drop us a message or visit us at our café.
          </AnimatedTextReveal>
        </section>

        <div className={styles.contentGrid}>
          <div className={`${styles.contactInfo} ${styles.animate}`} style={{ animationDelay: '0.2s' }}>
            <h2>Visit Us</h2>
          ...
          <form className={`${styles.contactForm} ${styles.animate}`} style={{ animationDelay: '0.4s' }} onSubmit={handleSubmit}>
        ...
        <section className={`${styles.eventsSection} ${styles.animate}`} style={{ animationDelay: '0.6s' }}>

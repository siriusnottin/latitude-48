...
const MenuPage = () => {
  const coffeeMenu = [
    {
      ...
      price: '$3.50',
      description:
        'Our signature blend, perfectly extracted for a rich and balanced shot.',
    },
    {
      name: 'Americano',
      price: '$4.00',
      description:
        'Espresso diluted with hot water, maintaining the full flavor of our coffee.',
    },
    {
      name: 'Cappuccino',
      price: '$4.50',
  ...
  const specialtyDrinks = [
    {
      ...
      price: '$5.25',
      description:
        'Espresso with rich chocolate, steamed milk, and whipped cream.',
    },
    {
      name: 'Caramel Macchiato',
      price: '$5.50',
      description:
        'Vanilla-infused milk marked with espresso and caramel drizzle.',
    },
    {
      name: 'Honey Lavender Latte',
      price: '$5.75',
      description:
        'Our signature latte with local honey and house-made lavender syrup.',
    },
  ];
  ...
  const featuredItems = [
    ...
    },
    {
      ...
      description:
        'Smooth cold brew coffee with tonic water and a hint of citrus.',
      price: '$5.25',
      image: coldBrewImage,
    },
  ];
        ...
        <main className={styles.menuContainer}>
          <section className={`${styles.heroSection} ${styles.animate}`}>
            ...
            <p className={styles.subtitle}>
              Carefully crafted coffee and specialty drinks made with love and
              precision
            </p>
          </section>
          ...
          <div className={styles.contentGrid}>
            <div
              className={`${styles.menuCategory} ${styles.animate}`}
          ...
          <section
            className={`${styles.featuredSection} ${styles.animate}`}
                  ...
                  <div className={styles.featuredContent}>
                    ...
                    <div className={styles.priceOrderContainer}>
                      ...
                      >
                        <span>
                          Order{' '}
                          <span className={styles.orderButtonIcon}>→</span>
                        </span>
                      </button>
                    </div>
                  </div>

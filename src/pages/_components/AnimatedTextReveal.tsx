...
interface AnimatedTextRevealProps extends Omit<TextRevealProps, 'animationKey'> {
  delay?: number;
}

export const AnimatedTextReveal: React.FC<AnimatedTextRevealProps> = ({ delay = 0, ...props }) => {
